...
const migrationFiles = [
  ...
  '0017_oauth-provider.sql', '0018_fts5-note-search.sql', '0019_note-routing-guide.sql', '0020_grant-sets.sql', // adds grants.familyId (the mintGrant INSERT lists it); appended LAST to keep slice/index below valid
];
