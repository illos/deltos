...
const migrations = [
  ...
  '0018_fts5-note-search.sql', '0019_note-routing-guide.sql', '0020_grant-sets.sql', '0021_oauth-refresh-token.sql', // FTS table; searchIndex.ts is invoked by the note mutators (0018)
