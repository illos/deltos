...
/**
 * ExportSection — the "Export" body of the combined Share screen (ShareExportPanel): the ROAD-0017 export
 * controls for the open note — Export as Markdown, Export as PDF, and Print. Renders NO overlay shell or
 * header of its own (the parent panel owns those), only its `.settings__section`.
 *
 ...
 * the export serializers / print machinery it pulls in (`exportNote` → shared serializers + the attachment
 * blob client) ever enter the mobile first-load bundle or the editor first-load path.
 *
...
export function ExportSection({ note }: ExportSectionProps) {
